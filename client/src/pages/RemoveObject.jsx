...
const RemoveObject = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    const cleanObject = object.trim().toLowerCase();
    ...
    // ✅ only one object
    if (cleanObject.split(" ").length > 1) {
      toast.error("Please enter only ONE object name (example: watch)");
      return;
    }
    ...
    try {
      ...
      formData.append("image", input); // must match multer field
      formData.append("object", cleanObject);
    ...
    <div className="min-h-0 w-full p-6 flex items-start flex-wrap gap-4 text-slate-700">
      ...
      >
        ...
        <textarea
          ...
          placeholder="Example: watch (only 1 word)"
          required
        />
        ...
        <button
          ...
          bg-gradient-to-r from-[#417DF7] to-[#8E37EB]
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="text-sm flex flex-col items-center gap-5 text-gray-400">
              ...
              <p>
                ...
                <span className="font-medium">"Remove Object"</span> to get
                started
              </p>
            </div>
          </div>
