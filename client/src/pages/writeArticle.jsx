  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      ...
      <form onSubmit={onSubmitHandler}
        ...
        <button
          disabled={loading} className="w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#226BFF] to-[#65ADFF] 
          text-white px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer hover:opacity-90 transition"
        >
          {
      ...
      min-h-96 max-h-[600vh]'>
        <div className='flex items-center gap-3'>
          <Edit className='w-5 h-5 text-[#4A71FF]' />
          <h1 className='text-xl font-semibold'>Genrated Article</h1>
        </div>
        ...
        {!content ? (
          <div className='flex-1 flex items-center justify-center'>
            <div className='text-sm flex flex-col items-center gap-5 text-gray-400'>
              ...
              <p>Enter a topic and click <span>"Genrate Article"</span> to get started</p>
            </div>
