...
const GenerateImages = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      setLoading(true)
      const prompt = `Genrate an Image of ${input} in the style ${selectedStyle}`
    ...
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      ...
      peer-checked:bg-green-500 transition'></div>
        ...
        <button disabled={loading}
          ...
          text-white px-4 py-2 mt-6 text-sm rounded-lg hover:opacity-90 transition"
        >
          ...
          !content ? (
            <div className='flex-1 flex items-center justify-center'>
              <div className='text-sm flex flex-col items-center gap-5 text-gray-400'>
                ...
                <p>
                  Enter a topic and click <span>"Generate Image"</span> to get started
                </p>
              </div>
            </div>)
            : (
